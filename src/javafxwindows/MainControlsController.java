...
public class MainControlsController implements Initializable {
    ...
    public void setBorderPane(BorderPane mpv) {
        this.mainPanelView = mpv;
    }
...
//    public MainControlsController(MediaPlayer mp, ImageView iv, BorderPane mpv, String mT) {
//        if (mp == null) {
//            this.imageView = iv;
//        } else {
//            this.mediaPlayer = mp;
...
//    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        filesButton.setOnAction((ActionEvent e) -> {
            ...
            FileChooser.ExtensionFilter mediaFilter = null;
            if (mediaType.equals("video")) {
                mediaFilter = new FileChooser.ExtensionFilter("Supported Media files (*.media)", "*.ogg", "*.ogv", "*.mp4", "*.m4v", "*.mpg", "*.flv", "*.mov", "*.mp3", "*.wav", "*.wma", "*.m4a");
            } else {
                mediaFilter = new FileChooser.ExtensionFilter("Supported Media files (*.media)", "*.png", "*.jpg", "*.jpeg", "*.gif", "*.tif", "*.bmp");
            }
            ...
            if (file != null) {
                ...
                if (mediaType.equals("video")) {
                    ...
                    imageView.fitHeightProperty().bind(mainPanelView.heightProperty());
                    imageView.fitWidthProperty().bind(mainPanelView.widthProperty());
                }
            }
        });
